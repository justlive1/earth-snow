 ...
 *
 */
public class JsonArrayToIntegerTypeHandler implements TypeHandler<JsonArray, Integer> {
  ...
  @Override
  public Class<Integer> getOutType() {
    return Integer.class;
  }

  @Override
  public Integer getResult(JsonArray resultSet, int index) {
